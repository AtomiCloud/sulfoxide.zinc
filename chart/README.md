...
| sulfoxide-bromine | object | `{"annotations":{"argocd.argoproj.io/sync-wave":"-3"},"rootSecret":{"ref":"SULFOXIDE_ZINC"},"storeName":"doppler-zinc"}` | Create SecretStore via secret of secrets pattern |
